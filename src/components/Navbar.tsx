    ...
    <nav className="bg-white border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center h-14 gap-8">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 shrink-0 text-gray-900 hover:text-brand-600">
            <svg
            ...
            <span className="font-bold text-base tracking-tight">PhysicsWithCode</span>
          </Link>
